# automated-export-system-performance-tests

## Overview

This repository contains performance tests for the Automated Export System (AES), which handles export declaration processing. Tests are run on staging only.

Performance test suite for the `Automated Export System`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
